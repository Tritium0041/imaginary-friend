...
def test_sealed_bid():
    ...
    # 玩家出价
    r1 = game_manager.record_sealed_bid("player_0", "art002", 30)
    r2 = game_manager.record_sealed_bid("player_1", "art002", 45)
    r3 = game_manager.record_sealed_bid("player_2", "art002", 40)
    ...
    # 揭示结果
    result = game_manager.reveal_sealed_bids("art002")
...
def test_play_function_card_and_resolve_event():
    ...
    if from_location != "player_0":
        transfer = game_manager.transfer_item("card", "func_11", from_location, "player_0")
    ...
    resolve_result = game_manager.resolve_event("event_10", refill_area=True)
